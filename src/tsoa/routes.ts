...
/**
 * Attach API routes to the provided Express Router, wiring endpoints to their controllers with request validation and standardized response handling.
 *
 * @param app - The Express Router instance to register routes on
 */
